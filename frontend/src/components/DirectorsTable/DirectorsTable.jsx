...
import DirectorsTableHoc from './DirectorsTableHoc';
...
class DirectorsTable extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                <Paper >
                    <DirectorsSearch name={ name } handleChange={ this.handleChange }
...
export default DirectorsTableHoc(DirectorsTable);